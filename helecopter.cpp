	...
	void frontscreen()
	{
		...
		glColor3f(0.0,0.0,0.0);
	 	...
	 	glColor3f(1.0,0.0,0.0);
	 		drawstring2(300,580,0.0,"Name :Preethi R          USN:4AD18CS056");
	 		drawstring2(300,540,0.0,"Name :Nesara V            USN:4AD17CS056");
	 	glColor3f(0.0,0.0,0.0);
	 		drawstring1(270,480,0.0,"Under the Guidance of");
	 	glColor3f(1.0,0.0,0.0);
	 		drawstring2(280,440,0.0,"Prof:Akshatha A, Dept. of CSE ");
	 	glColor3f(0.0,0.0,0.0);
